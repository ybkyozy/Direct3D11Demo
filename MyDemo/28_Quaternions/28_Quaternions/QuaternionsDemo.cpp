...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	QuaternionsDemo theApp(hInstance);
...
QuaternionsDemo::QuaternionsDemo(HINSTANCE hinstance):D3DApp(hinstance)
...
QuaternionsDemo::~QuaternionsDemo()
{
...
void QuaternionsDemo::UpdateScene(float dt)
{
	//
	// 控制摄像机
	//
...
void QuaternionsDemo::DrawScene()
{
...
void QuaternionsDemo::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void QuaternionsDemo::OnMouseUp(WPARAM btnState, int x, int y)
{
	// 不需要继续获得鼠标消息就释放掉
	ReleaseCapture();
}

void QuaternionsDemo::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void QuaternionsDemo::BuildShapeGeometryBuffers()
{
...
void QuaternionsDemo::BuildSkullGeometryBuffers()
{
