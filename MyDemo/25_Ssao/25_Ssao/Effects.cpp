...
void Effects::InitAll(ID3D11Device* device)
{
	...
	BuildShadowMapFX = new BuildShadowMapEffect(device, L"FX/BuildShadowMap.cso");
	SsaoNormalDepthFX = new SsaoNormalDepthEffect(device, L"FX/SsaoNormalDepth.cso");
	SsaoFX = new SsaoEffect(device, L"FX/Ssao.cso");
	SsaoBlurFX = new SsaoBlurEffect(device, L"FX/SsaoBlur.cso");
	SkyFX = new SkyEffect(device, L"FX/Sky.cso");
	DebugTexFX = new DebugTexEffect(device, L"FX/DebugTexture.cso");
}
